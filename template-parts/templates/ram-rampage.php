<section
    ...
    <div class="max-w-6xl xl:max-w-6xl lg:max-w-6xl md:max-w-6xl 3xl:max-w-8xl w-full mx-auto flex flex-col items-start px-5 md:px-0">
        ...
        <h2 class="text-base text-white font-normal font-neue z-50">A força e a tecnologia da RAM agora no tamanho certo
    ...
    <div class="max-w-6xl mx-auto w-full">
        ...
        <div class="w-full flex md:gap-5 md:flex-nowrap flex-wrap">
            <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                ...
                <p class="text-sm font-medium font-neue md:text-left text-center">2.2L Turbodiesel</p>
            </div>
            <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                <p class="text-base font-bold font-neue md:text-left text-center">Transmissão</p>
                <p class="text-sm font-medium font-neue md:text-left text-center">Automática de 9 marchas</p>
            </div>
            <div class="md:w-1/5 w-1/2 mb-5 md:mb-0 pl-10">
                <p class="text-base font-bold font-neue md:text-left text-center">Cilindradas</p>
                <p class="text-sm font-medium font-neue md:text-left text-center">1.995 cm³</p>
            </div>
            <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                <p class="text-base font-bold font-neue md:text-left text-center">Capacidade caçamba</p>
                <p class="text-sm font-medium font-neue md:text-left text-center">980 litros</p>
            </div>
            ...
            <div class="w-full h-full bg-cover bg-center"
                ...
                <div class="absolute inset-0 flex flex-col justify-end text-white transition-opacity">
                    <div class="px-5 md:px-10 2xl:px-2 bg-black-60 w-full">
                        ...
                        <p class="text-sm text-center font-neue hidden md:block 2xl:hidden">Potência e sofisticação em <br>um só ícone.</p>
                        <p class="text-sm text-center font-neue block md:hidden 2xl:block">Potência e sofisticação em um só ícone.</p>
                    </div>
                    <div class="mt-20 flex justify-end pb-5 px-5">
                        <button class="rounded-full cursor-pointer">
                            <img src="<?php echo get_theme_image('arrow-right.png') ?>" class="w-10">
...
<section class="bg-black pt-24 px-5 md:px-0">
    <div class="max-w-6xl xl:max-w-6xl lg:max-w-6xl md:max-w-6xl 3xl:max-w-8xl mx-auto md:flex md:justify-between md:gap-8">
        <div class="md:w-1/2 w-full">
            ...
            <p class="text-sm font-normal text-white font-neue md:mb-0 mb-5">Ofertas exclusivas, lançamentos e tudo
        ...
        <div class="md:w-1/2 w-full flex items-center">
            <form method="post" class="w-full">
                <div class="flex md:gap-5 items-center w-full md:flex-row flex-col justify-end">
                    ...
                    <button type="button"
                        class="bg-white newsletter-btn text-black rounded-xl px-4 py-2 cursor-pointer font-neue md:m-0 mx-auto transition-all duration-500 hover:red-ram hover:text-white">Inscreva-se
                        agora</button>
                </div>
            </form>
        </div>

<div id="ram1500">
    <section
        ...
        <div
            ...
            <h2 class="text-base text-white font-normal font-neue z-50">A potência que desafia os limites. O conforto
                <?php echo $row ?> transforma cada trajeto. Tudo o que você espera de uma <?php echo $row ?> RAM, elevado
                a um novo patamar.</h2>
        </div>
    </section>
    ...
    <section class="bg-white pb-11 pt-16 md:px-0 px-5" id="1500">
        <div class="max-w-6xl mx-auto w-full">
            <h3 class="uppercase font-medium text-2xl mb-10 font-neue md:text-left text-center">Ficha Técnica <span
                    class="font-bold font-neue">1500</span></h3>
            <div class="w-full flex md:gap-5 md:flex-nowrap flex-wrap">
                <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                    ...
                    <p class="text-sm md:text-left text-center font-medium font-neue">3.0L Hurricane 6 Biturbo</p>
                </div>
                <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                    <p class="text-base font-bold font-neue md:text-left text-center">Transmissão</p>
                    <p class="text-sm md:text-left text-center font-medium font-neue">Automática de 8 marchas</p>
                </div>
                <div class="md:w-1/5 w-1/2 mb-5 md:mb-0 md:pl-10">
                    ...
                    <p class="text-sm md:text-left text-center font-medium font-neue">2.998 cm³</p>
                </div>
                <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                    <p class="text-base font-bold font-neue md:text-left text-center">Capacidade caçamba</p>
                    <p class="text-sm md:text-left text-center font-medium font-neue">1.200 litros</p>
                </div>
                <div class="md:w-1/5 w-full mb-5 md:mb-0">
                    ...
                    <p class="text-sm md:text-left text-center font-medium font-neue">5 lugares</p>
                </div>
            </div>
            ...
            <div class="ram-card md:w-1/4 w-1/2 md:h-[520px] h-[360px] cursor-pointer relative group overflow-hidden relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gradient-to-t before:from-black/50 before:via-black/10 before:to-transparent before:opacity-0"
                ...
                <div class="w-full h-full bg-cover bg-center"
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end text-white transition-opacity">
                        ...
                        <div class="mt-20 flex justify-end pb-5 px-5 px-5">
                            <button class="rounded-full cursor-pointer">
                                <img src="<?php echo get_theme_image('arrow-right.png') ?>" class="w-10">
                            </button>
                        </div>
                ...
                <div class="w-full h-full bg-cover bg-center"
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end text-white transition-opacity">
                        <div class="px-5 md:px-10 2xl:px-2 bg-black-60 w-full">
                            ...
                            <p class="text-sm text-center font-neue 2xl:hidden md:block hidden">Força bruta para quem
                                precisa <br>ir
                                além.
                            </p>
                            <p class="text-sm text-center font-neue block 2xl:block md:hidden">Força bruta
                                <?php echo $row ?> para quem <?php echo $row ?>
                                precisa ir além.</p>
                        </div>
                        <div class="mt-20 flex justify-end pb-5 px-5">
                            <button class="rounded-full cursor-pointer">
                ...
                <div class="w-full h-full bg-cover bg-center"
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end text-white transition-opacity">
                        <div class="px-5 md:px-10 2xl:px-2 bg-black-60 w-full">
                            ...
                            <p class="text-sm text-center font-neue">Máxima capacidade <?php echo $row ?> para os
                                desafios mais <?php echo $row ?> exigentes.
                            </p>
                        </div>
                        <div class="mt-20 flex justify-end pb-5 px-5">
                            <button class="rounded-full cursor-pointer">
    ...
    <section class="bg-black md:pt-24 pt-16 px-5 md:px-0">
        <div
            ...
            <div class="md:w-1/2 w-full">
                ...
                <p class="text-sm font-normal text-white font-neue md:mb-0 mb-5">Receba novidades, ofertas exclusivas e

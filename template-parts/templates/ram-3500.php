<div id="ram3500">
    <section
        ...
        style="background-image: url(<?php echo get_theme_image('bg-ram3500.jpg') ?>);">
        <div
            ...
            <h1 class="text-white md:text-5xl text-4xl text-left mb-5 font-semibold font-neue z-50">RAM 3500: Poder
                Inigualável para <br>os desafios mais exigentes.
            </h1>
            <h2 class="text-sm text-white font-extralight font-neue z-50">Se a sua jornada exige força máxima,
                capacidade<br>
        ...
        <div class="max-w-6xl mx-auto w-full">
            ...
            <div class="w-full flex md:gap-5 md:flex-nowrap flex-wrap">
                <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                    ...
                    <p class="text-sm font-medium font-neue md:text-left text-center">6.7L Cummins Turbo Diesel, 6
                        cilindros em linha
                    </p>
                </div>
                <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                ...
                <div class="md:w-1/5 w-1/2 mb-5 md:mb-0">
                    ...
                    <p class="text-sm font-medium font-neue md:text-left text-center">1.280 litros</p>
                </div>
    ...
    <section class="bg-black md:pt-24 pt-16 px-5 md:px-0">
        <div
            ...
            <div class="md:w-1/2 w-full">
                ...
                <p class="text-sm font-normal text-white font-neue md:mb-0 mb-5">Novas tecnologias, ofertas exclusivas e
                    tudo sobre a picape mais forte da categoria, direto no seu e-mail. Cadastre-se e fique por dentro do
                    universo RAM.</p>
            </div>
